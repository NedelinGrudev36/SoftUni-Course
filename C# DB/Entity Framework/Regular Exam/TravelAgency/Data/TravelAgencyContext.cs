...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=NEDO\SQLEXPRESS;Database=TravelAgency;Integrated Security=True;Encrypt=False";
        ...
        public virtual DbSet<TourPackageGuide> ToursPackagesGuides { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder
                ...
                .HasKey(tpc => new { tpc.TourPackageId, tpc.GuideId });
